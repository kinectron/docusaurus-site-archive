...
const recorded_data_file = "./assets/data/azure_recorded_skeleton.json";
...
function preload() {
  ...
  headImg = loadImage("./assets/images/skeleton_images/skull.png");
  torsoImg = loadImage("./assets/images/skeleton_images/torso.png");
  hipImg = loadImage("./assets/images/skeleton_images/hips.png");
  boneImg = loadImage("./assets/images/skeleton_images/bone.png");
  boneSmallImg = loadImage("./assets/images/skeleton_images/boneSmall.png");
  legLeftImg = loadImage("./assets/images/skeleton_images/leftLeg.png");
  legRightImg = loadImage("./assets/images/skeleton_images/rightLeg.png");
}
