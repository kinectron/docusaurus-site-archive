---
id: example-skeleton-images-azure
title: Skeleton Images Example (Azure Kinect)
sidebar_label: Skeleton Images Example (Azure Kinect)
---
...
<script src="assets/scripts/example-skeleton-imgs-a.js"></script>
...
const recorded_data_file = "js/azure_recorded_skeleton.json";
