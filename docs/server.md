...
Download and unzip [preview release 0.3.6](https://github.com/kinectron/kinectron/releases/tag/0.3.6). Make sure you download the file that is linked from dropbox in the release description. The file will be labeled "Kinectron.xxxx.zip," you do not need the files labeled "Source Code."
